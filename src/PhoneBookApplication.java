...
/** The PhoneBook program implements an application that
 * allows the user to add contacts, search contacts by name, phone number, city and state, as well delete records as well as place records in ascendeing order.
	...
	public static void displayMenu() {
		...
		while(true) {
			...
			case 1 : 
				...
				System.out.print("Enter the State, Example: TN ");
				String state = inString.nextLine();
				System.out.print("Enter Zip Code,Example 63101 ");
			...
			case 2 : 
				System.out.println("Enter the  phone number you would like to delete ");
			...
			default:
				...
				System.out.println("Please enter a number betweent 1-11");
